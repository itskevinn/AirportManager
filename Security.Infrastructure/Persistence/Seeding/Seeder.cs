...
public static class Seeder
{
    public static void GenerateSeeds(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MenuItem>().HasData(
            ...
            new
            {
                Id = Guid.Parse("504731d4-0a34-41d5-9b0b-0611b3f76097"), Icon = "fa-solid fa-city",
                Label = "Ciudades",
                Order = 1,
                RouterLink = "cities",
                CreatedBy = "AutoGenerated",
            ...
            new
            {
                Id = Guid.Parse("504731d4-0a34-41d5-9b0b-0611b3f76000"), Icon = "fa-solid fa-building",
                Label = "Aerolíneas",
                Order = 1,
                RouterLink = "airlines",
                CreatedBy = "AutoGenerated",
            ...
            new MenuItem
            {
                Id = Guid.Parse("504731d4-0a34-41d5-9b0b-0611b3f76098"), Icon = "fa-solid fa-user",
                Label = "Usuarios",
        ...
        modelBuilder.Entity<MenuItemRole>().HasData(
            ...
            {
                Id = Guid.Parse("C82A18C6-E473-4976-5F2E-08DA35E4EBAA"),
                MenuItemId = Guid.Parse("504731d4-0a34-41d5-9b0b-0611b3f76097"),
                RoleId = Guid.Parse("BF1DE1AA-FC78-4B92-6942-08DA36131198"),
                Status = true,
                CreatedBy = "AutoGenerated",
                CreatedOn = new DateTime(),
            ...
            new
            {
                Id = Guid.Parse("C82A18C6-E473-4976-5F2E-08DA35E4EBBB"),
                MenuItemId = Guid.Parse("504731d4-0a34-41d5-9b0b-0611b3f76000"),
                RoleId = Guid.Parse("BF1DE1AA-FC78-4B92-6942-08DA36131198"),
                Status = true,
                CreatedBy = "AutoGenerated",
                CreatedOn = new DateTime(),
